...
class _$ProfileResponseImpl implements _ProfileResponse {
  const _$ProfileResponseImpl({required this.username, required this.email});
  ...
  @override
  String toString() {
    return 'ProfileResponse(username: $username, email: $email)';
  }
...
abstract class _ProfileResponse implements ProfileResponse {
  const factory _ProfileResponse(
      ...
      required final String email}) = _$ProfileResponseImpl;
