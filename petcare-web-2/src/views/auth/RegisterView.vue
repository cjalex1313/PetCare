<template>
  <div class="h-screen flex items-center justify-center flex-col">
    ...
    <FloatLabel class="mb-6">
      <Password inputClass="w-64" id="password" v-model="registerData.password" :feedback="false" toggleMask />
      <label for="password">Password</label>
    </FloatLabel>
    <FloatLabel class="mb-6">
      <Password inputClass="w-64" id="confirmPassword" v-model="registerData.confirmPassword" :feedback="false"
        toggleMask />
